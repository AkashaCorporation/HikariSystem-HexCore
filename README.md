...
|-----------|---------|-------------|
| **Debugger** | 2.1.2 | PE/ELF emulation with Unicorn Engine, 70+ API hooks, IPC Smart Sync, stdin emulation, PRNG modes, side-channel analysis |
| **Disassembler** | 1.4.11 | Multi-arch disassembler with inline PE/ELF parsing, function detection, string xrefs, IR lifting, junk filtering, VM detection, callfuscation detection |
