  ...
  "targets": [
    {
      ...
      "conditions": [
        [
          ...
          {
            "libraries": [
              "<(module_root_dir)/deps/souper/lib/souperExtractor.lib",
              "<(module_root_dir)/deps/souper/lib/souperInfer.lib",
              "<(module_root_dir)/deps/souper/lib/souperInst.lib",
              "<(module_root_dir)/deps/souper/lib/souperKVStore.lib",
              "<(module_root_dir)/deps/souper/lib/souperParser.lib",
              "<(module_root_dir)/deps/souper/lib/souperSMTLIB2.lib",
              "<(module_root_dir)/deps/souper/lib/souperTool.lib",
              "<(module_root_dir)/deps/souper/lib/souperCodegen.lib",
              "<(module_root_dir)/deps/souper/lib/kleeExpr.lib",
              "<(module_root_dir)/deps/alive2/lib/ir.lib",
              "<(module_root_dir)/deps/alive2/lib/smt.lib",
              "<(module_root_dir)/deps/alive2/lib/tools.lib",
              "<(module_root_dir)/deps/alive2/lib/util.lib",
              ...
              "<(module_root_dir)/deps/hiredis/lib/hiredis.lib"
            ],
            "msvs_settings": {
              "VCCLCompilerTool": {
                "ExceptionHandling": 1,
